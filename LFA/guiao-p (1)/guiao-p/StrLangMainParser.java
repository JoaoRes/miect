...
public class StrLangMainParser extends Parser {
	...
	public static class ExprSubsContext extends ExpressionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof StrLangMainListener ) ((StrLangMainListener)listener).enterExprSubs(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof StrLangMainListener ) ((StrLangMainListener)listener).exitExprSubs(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof StrLangMainVisitor ) return ((StrLangMainVisitor<? extends T>)visitor).visitExprSubs(this);
			else return visitor.visitChildren(this);
		}
	}
