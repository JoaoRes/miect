...
public interface StrLangMainVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code ExprRender}
	 * labeled alternative in {@link StrLangMainParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprRender(StrLangMainParser.ExprRenderContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprReplace(StrLangMainParser.ExprReplaceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprAdd(StrLangMainParser.ExprAddContext ctx);
	/**
