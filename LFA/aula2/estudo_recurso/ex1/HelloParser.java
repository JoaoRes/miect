...
public class HelloParser extends Parser {
	...
	public static final int
		RULE_choose = 0, RULE_greetings = 1, RULE_bye = 2, RULE_name = 3;
	private static String[] makeRuleNames() {
		return new String[] {
			"choose", "greetings", "bye", "name"
		};
	}
	...
	public static class ChooseContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).enterChoose(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HelloListener ) ((HelloListener)listener).exitChoose(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof HelloVisitor ) return ((HelloVisitor<? extends T>)visitor).visitChoose(this);
