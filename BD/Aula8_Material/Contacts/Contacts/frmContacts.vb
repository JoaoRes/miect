...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '' Change this line...
        CN = New SqlConnection("data source=DESKTOP-JR2SDSQ\SQLEXPRESS;integrated security=true;initial catalog=Northwind")
    ...
    Private Sub LoadCombo()
        CMD.CommandText = "SELECT DiSTINCT OrderDate FROM Orders"
        ComboBox1.Items.Clear()
        CN.Open()
        Dim RDR As SqlDataReader
        RDR = CMD.ExecuteReader
        While RDR.Read
            ComboBox1.Items.Add(Convert.ToString(IIf(RDR.IsDBNull(RDR.GetOrdinal("OrderDate")), "", RDR.Item("OrderDate"))))
        End While
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        CMD.CommandText = "Select * from Orders Where OrderDate = " + ComboBox1.Text()
        ListBox1.Items.Clear()
        ...
        RDR = CMD.ExecuteReader
        While RDR.Read
            ListBox1.Items.Add(Convert.ToString(IIf(RDR.IsDBNull(RDR.GetOrdinal("OrderID")), "", RDR.Item("OrderID"))))
        End While
        CN.Close()
